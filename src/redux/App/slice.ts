...
const getInitialOutbreakName = (): keyof typeof OutbreakNames => {
  ...
  const urlValue = params.get("outbreakName") as
...
export const appSlice = createSlice({
  ...
  reducers: {
    ...
    setOutbreakName: (
      state,
      action: PayloadAction<keyof typeof OutbreakNames>,
    ) => {
...
export const { setFocusedArea, setPopup, setOutbreakName, setResolution } =
  appSlice.actions;
